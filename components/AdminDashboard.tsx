...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ reservations, menuItems, onUpdateStatus, onUpdateMenuPrice, onAddMenuItem, onLogout, isDbConnected }) => {
  ...
  // Load Orders Immediately on Mount (Fix for Financial Report bug)
  useEffect(() => {
    ...
    loadOrders(); // Force load immediately
  ...
  }, [isDbConnected]); // Removed activeTab dependency to ensure data is always present
